...
Offset_0x046682:
                ...
                move.b  #$20, x_radius(A0)                            ; $001F
                move.b  #$12, y_radius(A0)                           ; $001E
                moveq   #$00, D0
                move.b  subtype(A0), D0                              ; $002C
                lsr.w   #$01, D0
                move.b  Offset_0x0466B6(PC, D0), routine(A0)         ; $0005
                tst.w   D0
                bne     Offset_0x046738
...
Offset_0x0466C4:
                ...
                move.l  #Offset_0x0466EE, child(A0)                  ; $0034
                rts   
;-------------------------------------------------------------------------------
Offset_0x0466DA:
                moveq   #$01, D0
...
Offset_0x04679E:
                ...
                move.w  #$5D6A, x_pos(A1)                                ; $0010
                move.w  #$027A, y_pos(A1)                                ; $0014
...
Offset_0x0468B4:
                ...
                move.l  #Offset_0x046B02, child_data(A0)             ; $0030
                moveq   #$00, D0
                move.b  subtype(A0), D0                              ; $002C
                move.w  Offset_0x0468E0(PC, D0), objoff_42(A0)  ; $0042
