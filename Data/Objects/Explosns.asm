...
Boss_Explosion_Control:                                        ; Offset_0x041BDE
                ...
                move.l  #Obj_Normal_Explode, objoff_34(A0) ; Offset_0x041C30, $0034
                cmpi.b  #$08, subtype(A0)                            ; $002C
                bne.s   Offset_0x041BFE
                move.l  #Offset_0x041C7A, objoff_34(A0)         ; $0034
Offset_0x041BFE:
