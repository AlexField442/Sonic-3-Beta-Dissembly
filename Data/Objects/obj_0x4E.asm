...
Offset_0x029C80:
                ...
                bclr    #$01, render_flags(A1)                              ; $0004
                bset    #$06, objoff_2E(A1)                              ; $002E
                bset    #$01, objoff_2E(A1)                              ; $002E
Offset_0x029C9E:
                rts
Offset_0x029CA0:
                tst.b   $0001(A2)
...
Offset_0x029D0E:
                ...
                bclr    #$06, objoff_2E(A1)                              ; $002E
                bclr    #$01, objoff_2E(A1)                              ; $002E
...
Offset_0x029DA4:
                ...
                andi.w  #$00FF, D0
                divu.w  #$000B, D0
                move.b  Offset_0x029DC6(PC, D0), mapping_frame(A1)          ; $0022
                moveq   #$00, D0
...
Offset_0x029EF4:
                ...
                andi.w  #$00FF, D0
                divu.w  #$000B, D0
                move.b  Offset_0x029F16(PC, D0), mapping_frame(A1)          ; $0022
                moveq   #$00, D0
                move.b  mapping_frame(A1), D0                               ; $0022
                jmp     (Load_Sonic_Dynamic_PLC_D0)            ; Offset_0x00C7F0      
;-------------------------------------------------------------------------------
...
Offset_0x029F2E:
                ...
                move.w  parent(A1), A3                          ; $0042
                bclr    D6, status(A3)                               ; $002A
Offset_0x029F3E:
                move.w  A0, parent(A1)                          ; $0042
                btst    #$01, status(A1)                             ; $002A
