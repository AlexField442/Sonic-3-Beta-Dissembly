...
Offset_0x044CF2:
                ...
                move.l  #Offset_0x044F8C, child_data(A0)             ; $0030
Offset_0x044D02:
                rts   
;-------------------------------------------------------------------------------
Offset_0x044D04:
                ...
                neg.w   D4
Offset_0x044D22:
                add.w   D4, y_pos(A0)                                    ; $0014
Offset_0x044D26:
                move.w  y_pos(A0), D4                                    ; $0014
...
Offset_0x044DCE:
                ...
                andi.b  #$01, D2
                move.b  render_flags(A1), D3                                ; $0004
                andi.b  #$01, D3
                eor.b   D2, D3
                beq.s   Offset_0x044E16
                bchg    #00, render_flags(A0)                               ; $0004
                bchg    #00, objoff_38(A0)                      ; $0038
...
Offset_0x044E68:
                ...
                move.w  (A2)+, A3
                move.w  A3, objoff_3E(A0)                       ; $003E
                move.w  (A3), objoff_3A(A0)                     ; $003A
