...
Obj_0x69_Hz_Curved_Twisting_Pipe:                              ; Offset_0x02EEEA
                ...
                move.w  (A1)+, objoff_30(A0)                    ; $0030
                move.w  (A1)+, objoff_32(A0)                    ; $0032
                move.l  (A1)+, objoff_40(A0)                    ; $0040
                move.l  #Offset_0x02EF0A, (A0)
Offset_0x02EF0A:                
                lea     (Obj_Player_One).w, A1                       ; $FFFFB000
                lea     objoff_34(A0), A4                       ; $0034
...
Offset_0x02F076:
                ...
                muls.w  inertia(A1), D1                              ; $001C
                asr.l   #$08, D1
                move.w  D1, x_vel(A1)                              ; $0018
                muls.w  inertia(A1), D0                              ; $001C
                asr.l   #$08, D0
                ...
                asr.l   #$02, D0
Offset_0x02F0B0:
                cmpi.w  #$1800, inertia(A1)                          ; $001C
                bge.s   Offset_0x02F0C8
                add.w   D0, inertia(A1)                              ; $001C
                rts
Offset_0x02F0BE:
                tst.w   D0
