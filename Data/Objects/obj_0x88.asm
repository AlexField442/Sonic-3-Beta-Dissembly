...
Offset_0x048772:
                ...
                move.l  #Offset_0x048A88, child_data(A0)             ; $0030
...
Offset_0x04879A:
                ...
                jmp     SetupChildObject(PC)               ; Offset_0x041D9A
Offset_0x0487AA:
                move.l  #Offset_0x048A8E, child_data(A0)             ; $0030
...
Offset_0x048802:
                ...
                move.b  #$F0, objoff_43(A0)                     ; $0043
                move.w  x_pos(A0), objoff_3E(A0)         ; $0010, $003E
                move.w  y_pos(A0), objoff_40(A0)         ; $0014, $0040
                bra     Offset_0x0489FC       
;-------------------------------------------------------------------------------
Offset_0x048826:
...
Offset_0x048846:
                ...
                move.l  #Offset_0x0488C0, child(A0)                  ; $0034
                rts    
;-------------------------------------------------------------------------------
Offset_0x048856:
                moveq   #$00, D0
...
Offset_0x04886E:
                ...
                move.l  #Offset_0x0488D4, child(A0)                  ; $0034
                rts   
;-------------------------------------------------------------------------------
Offset_0x048888:
...
Offset_0x0488D4:
                ...
                move.l  #Offset_0x04890A, child(A0)                  ; $0034
                clr.w   y_vel(A0)                                  ; $001A
Offset_0x0488EC:
                rts 
;-------------------------------------------------------------------------------
...
Offset_0x04890A:
                ...
                neg.w   x_vel(A0)                                  ; $0018
                move.w  #$000F, objoff_2E(A0)                            ; $002E
                move.l  #Offset_0x048944, child(A0)                  ; $0034
                rts            
;-------------------------------------------------------------------------------  
Offset_0x048924:
...
Offset_0x048932:
                move.w  y_pos(A0), D0                                    ; $0014
                subq.w  #$02, D0
                cmp.w   objoff_40(A0), D0                       ; $0040
                bls.s   Offset_0x048944
                move.w  D0, y_pos(A0)                                    ; $0014
                rts
Offset_0x048944:
                move.b  #$02, routine(A0)                            ; $0005
                move.w  objoff_3E(A0), x_pos(A0)         ; $003E, $0010
                move.w  objoff_40(A0), y_pos(A0)         ; $0040, $0014
                move.w  parent3(A0), A1                            ; $0046
...
Offset_0x04898A:
                ...
                move.w  y_pos(A1), D3                                    ; $0014
                sub.w   objoff_3E(A0), D2                       ; $003E
                sub.w   objoff_40(A0), D3                       ; $0040
                moveq   #$00, D0
                move.b  subtype(A0), D0                              ; $002C
...
Offset_0x0489B6:
                asr.w   #$02, D2
                neg.w   D2
                add.w   x_pos(A1), D2                                    ; $0010
                move.w  D2, x_pos(A0)                                    ; $0010
                asr.w   #$02, D3
                neg.w   D3
                add.w   y_pos(A1), D3                                    ; $0014
                move.w  D3, y_pos(A0)                                    ; $0014
                rts   
;-------------------------------------------------------------------------------
Offset_0x0489D0:
                asr.w   #$01, D2
                add.w   objoff_3E(A0), D2                       ; $003E
                move.w  D2, x_pos(A0)                                    ; $0010
                asr.w   #$01, D3
                add.w   objoff_40(A0), D3                       ; $0040
                move.w  D3, y_pos(A0)                                    ; $0014
                rts  
;-------------------------------------------------------------------------------
Offset_0x0489E6:
