...
Obj_0x47_CNz_Barrel:                                           ; Offset_0x028430
                ...
                move.l  #Barrel_Mappings, mappings(A0)   ; Offset_0x0288E8, $000C
                move.w  #$438E, art_tile(A0)                         ; $000A
                move.b  #$04, render_flags(A0)                              ; $0004
                move.w  #$0280, priority(A0)                         ; $0008
                move.b  #$20, width_pixels(A0)                              ; $0007
                move.b  #$20, height_pixels(A0)                             ; $0006
                move.w  x_pos(A0), objoff_2E(A0)                  ; $0010, $002E
                ...
                subi.b  #$0A, D0
                andi.b  #$03, D0
                move.b  D0, default_y_radius(A0)                             ; $0044
                andi.w  #$00F0, D1
                lsl.w   #$02, D1
...
Offset_0x02854C:
                ...
                cmpi.w  #$0080, D0
                bcc.s   Offset_0x028578
                addi.w  #$0400, y_vel(A0)                          ; $001A
                move.w  objoff_3E(A0), D0                       ; $003E
                cmp.w   y_vel(A0), D0                              ; $001A
...
Offset_0x028710:
                ...
                subq.b  #$01, default_y_radius(A0)                           ; $0044
                andi.b  #$03, default_y_radius(A0)                           ; $0044
Offset_0x02873A:
                move.w  #$0020, D2
                move.b  angle(A0), D0                                ; $0026
                cmpi.b  #$80, D0
...
Offset_0x028752:
                ...
                addi.b  #$80, D0
                move.b  D0, angle(A0)                                ; $0026
                addq.b  #$01, default_y_radius(A0)                           ; $0044
                andi.b  #$03, default_y_radius(A0)                           ; $0044
Offset_0x028776:
                move.w  #$0020, D2
Offset_0x02877A:
                jsr     (CalcSine)                             ; Offset_0x001B20
                asr.w   #$03, D1
                move.b  default_y_radius(A0), D3                             ; $0044
                andi.b  #$03, D3
                bne.s   Offset_0x0287A0
                add.w   objoff_2E(A0), D1                                ; $002E
