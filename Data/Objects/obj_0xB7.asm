...
Offset_0x0493E8:                
                ...
                move.w  #$01DF, objoff_2E(A0)                            ; $002E
                move.l  #Offset_0x04945E, child(A0)                  ; $0034
...
Offset_0x04945E:
                ...
                clr.w   x_vel(A0)                                  ; $0018
                move.l  #Offset_0x049472, child(A0)                  ; $0034
                rts                 
;-------------------------------------------------------------------------------
Offset_0x049472:
...
Offset_0x049480:
                ...
                move.l  #Offset_0x0494C0, child(A0)                  ; $0034
Offset_0x0494BC:
                jmp     Delete_Sprite_Clear_Respaw_Flag_Check_X(PC) ; Offset_0x042B3C  
;-------------------------------------------------------------------------------
Offset_0x0494C0:
...
Offset_0x0494D4:
                ...
                move.l  #Offset_0x049532, child(A0)                        ; $0034
                jsr     (Swing_Setup)                          ; Offset_0x03669A
Offset_0x049514:
                jmp     Delete_Sprite_Clear_Respaw_Flag_Check_X(PC) ; Offset_0x042B3C    
;-------------------------------------------------------------------------------
...
Offset_0x049532:
                ...
                move.l  #Offset_0x04954E, child(A0)                  ; $0034
                rts              
;-------------------------------------------------------------------------------
Offset_0x04954E:
